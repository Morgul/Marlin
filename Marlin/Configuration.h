...
#define STRING_CONFIG_H_AUTHOR "(Morgul, kossel-mini config)" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Kosh config v1.0.0-alpha.1"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Kosh Mini Kossel"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 220 // (measured: 228.40) get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 146.4 //mm  Get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 160, 295.685 }  // default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 300, 150 }
